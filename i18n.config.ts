export default defineI18nConfig(() => ({
  ...
  messages: {
    en: {
      ...
      successClaim: "2 Coins added successfuly!",
      errorClaim: "You can claim the reward only once every 24 hours!",
      ...
      loginToClaim: "Please log in to claim your reward.",
      upgradeToVipClaim: "You need to have a VIP account to claim the reward.",
      ...
      videoRecommended: "Payment errors",
      videoRecommendedDetails: "We apologize for the payment errors that occurred on the server. Everything should be working smoothly now. If you experienced any issues, please reach out to us, and we'll be happy to offer refunds or compensation in COINs. We're sorry for any inconvenience this may have caused!",
      doNotClose:
    ...
    kr: {
      ...
      successClaim: "2 코인이 성공적으로 추가되었습니다!",
      errorClaim: "보상은 24시간에 한 번만 청구할 수 있습니다!",
      ...
      galleries: "갤러리",
      totalResults: "전체 결과",
      loginToClaim: "보상을 받으려면 로그인해 주세요.",
      upgradeToVipClaim: "보상을 받으려면 VIP 계정이 필요합니다.",
      goToRewards: "보상으로 이동",
      newRewardSystem: "새로운 보상 시스템 이용 가능!",
      greatNews:
        "좋은 소식! VIP 사용자는 매일 무료 코인 보상을 받을 수 있습니다!",
      rewardValue: "보상 가치는 매일 2 코인입니다",
      videoRecommended: "결제 오류",
      videoRecommendedDetails: "서버에서 발생한 결제 오류에 대해 사과드립니다. 지금은 모든 것이 순조롭게 진행될 것입니다. 문제가 발생한 경우 저희에게 연락주시면 COIN으로 환불이나 보상을 기꺼이 제공하겠습니다. 이로 인해 불편을 끼쳐드려 죄송합니다!",
    ...
    cn: {
      ...
      successClaim: "成功添加 2 个金币！",
      errorClaim: "每24小时只能领取一次奖励！",
      ...
      galleries: "画廊",
      totalResults: "总结果",
      loginToClaim: "请登录以领取您的奖励。",
      upgradeToVipClaim: "您需要拥有 VIP 账户才能领取奖励。",
      goToRewards: "前往奖励",
      newRewardSystem: "新奖励系统可用！",
      greatNews: "好消息！VIP 用户每天可以享受免费金币奖励！",
      rewardValue: "奖励价值是每天 2 个金币",
      videoRecommended: "付款错误",
      videoRecommendedDetails: "对于服务器上发生的付款错误，我们深表歉意。现在一切都应该顺利进行。如果您遇到任何问题，请联系我们，我们很乐意以 COIN 形式提供退款或补偿。对于由此造成的任何不便，我们深表歉意！",
